...
# MAGIC %pip install /Workspace/Applications/ucx/wheels/databricks_labs_ucx-0.59.1-py3-none-any.whl -qqq
...
from databricks.labs.lsql.dashboards import Dashboards, Dataset 
...
class QuickFixDashboards(Dashboards):
    def __init__(self, ws):
        super().__init__(ws)
        self._ws = ws

    def get_dashboard(self, dashboard_path: str) -> json:
...
def export_results() -> None:
    ...
    dashboard_datasets = QuickFixDashboards(ctx.workspace_client).get_dashboard(assessment_dashboard)
